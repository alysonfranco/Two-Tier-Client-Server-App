...
public class TheAccountantApp extends JPanel {
	/*************
	 * Variables
	 *************/
	...
	// define JComboBoxes
	private JTextField dbPropertiesBox;
	private JTextField userPropertiesBox;
	...
	private Connection connect; // idk what this is for yet
	private JTable resultTable;

	private ResultSetTableModel tableModel; // idk what this is for yet
	...
	public TheAccountantApp() {
		...
		String dbProperties = "operationslog.properties";
		...
		styleButton(ClearCommand, Color.WHITE, Color.RED);
		...
		dbPropertiesBox = new JTextField(dbProperties);
//		dbPropertiesBox.setEditable(false);
		dbPropertiesBox.setBackground(Color.WHITE);

		userPropertiesBox = new JTextField(userProperties);
//		userPropertiesBox.setEditable(false);
	...
	private void registerListeners() {
		...
		ConnectButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				String dbPropertiesFile = dbPropertiesBox.getText();
				String userPropertiesFile = userPropertiesBox.getText();
			...
			public void actionPerformed(ActionEvent event) {
				...
				try {
					...
					if (sqlCommand.toLowerCase().startsWith("select")) {
						...
						JOptionPane.showMessageDialog(null, "Succesful Update..." + rowsAffected + " rows updated",
	...
	public static void main(String[] args) {
		// debug code
		System.out.println("TheAccountantApp started.");
		// new JFrame
		JFrame frame = new JFrame("Accountant Application (AF - CNT 4714 - Summer 2024 - Project 2)");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		// create Prog3_GUI
		TheAccountantApp app = new TheAccountantApp();
		frame.getContentPane().add(new TheAccountantApp());
		frame.pack();
		...
		frame.addWindowListener(new WindowAdapter() {
			public void windowClosed(WindowEvent event) {
				...
				// debug code
				System.out.println("TheAccountantApp ended.");
				System.exit(0);
			}
